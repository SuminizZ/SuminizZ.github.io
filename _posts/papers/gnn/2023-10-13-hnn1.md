...
- [**4. Generalization of Euclidean Neural Networks to Hyperbolic Spaces**](#4-generalization-of-euclidean-neural-networks-to-hyperbolic-spaces)
    - [**3.1. Mapping between Hyperbolic Manifold and Tangent Spaces**](#31-encoder-decoder-architecture-for-semi-supervised-learning)
    - [**3.2. Gyrovector Based Arithmetic Operations with Mobius Transformation**](#32-joint-loss-fucntions)
    - [**3.3. Implementing Hyperbolic Neural Networks**](#33-joint-loss-fucntions)
...
- Therefore, in order to use hyperbolic space as an alternative framework of neural networks, all these operations need to be re-defined in a way consistent to the given hyperbolic geometry.

&emsp; <img src="https://github.com/SuminizZ/Algorithm/assets/92680829/59bf39a9-4b81-45ab-b245-7db7b5468616" width="800">