...
- [**4. Generalization of Euclidean Neural Networks to Hyperbolic Spaces**](#4-generalization-of-euclidean-neural-networks-to-hyperbolic-spaces)
    - [**4.1. Mapping between Hyperbolic Manifold and Tangent Spaces**](#31-encoder-decoder-architecture-for-semi-supervised-learning)
    - [**4.2. Gyrovector Based Arithmetic Operations with Möbius Transformation**](#32-joint-loss-fucntions)
    - [**4.3. Implementing Hyperbolic Neural Networks**](#33-joint-loss-fucntions)
...
### **4.2. Gyrovector Based Arithmetic Operations with Möbius Transformation**
...
### **4.3. Implementing Hyperbolic Neural Networks**

<br/>

(To complete 4.2.2 and 4.3, I need further study about Mobius transformation and complex analysis. Will be updated later.)
