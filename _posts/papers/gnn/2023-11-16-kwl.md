---
layout: post
title : "[Papers Review] Weisfeiler-Lehman Graph Isomorphism Test & Applications to GNN (k-GNN and GIN)"
...
- [**3. GIN**](#2-node2vec)
    - [**3.1. Biased Random Walks**](#21-biased-random-walks)
    - [**3.2. Comparison to Other Node Embedding Strategies**](#32-comparison-to-other-node-embedding-strategies) 
...
- The what is the effect of this seemingly minor change in 
